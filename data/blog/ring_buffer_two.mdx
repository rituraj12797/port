...
I make a lot of mis-spells so for that obvious reason I have used Agentic-AI to write gramatically correct comments(only) for me, code is purely written by me.
