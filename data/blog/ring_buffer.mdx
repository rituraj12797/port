...
date: '2026-1-05'
tags: ['C++', 'System Design', 'Lock Free', 'Ring Buffer']
draft: false
...
namespace internal_lib {
    ...
    class LFQueue final { // why final here ===> final is a keyword that means no other class is going to inherit this class hence the compiler devirtualizes it ==> performance gains 
    private :
        std::vector<T> store_; 
...
Below is a table obtained after benchmarking this queue against `std::queue` + Mutex.